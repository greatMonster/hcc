  ...
  <div class="edit-box">
    <div class="rthirty-five-time">
      <div class="rthirty-five-box3">员工在
        一周内，
        总工时不得超过
        <el-input v-model="data.adRules.common[0].maxTime" type="text" placeholder="" class="percentCount" style="width:60px" /> 小时
        总工时不得小于
        <el-input v-model="data.adRules.common[0].minTime" type="text" placeholder="" class="percentCount" style="width:60px" /> 小时
      </div>
    </div>
  </div>
</template>
