  ...
  <div class="edit-box">
    <div class="rthirty-five-time">
      <div class="rthirty-five-box3">
        <div style=" float: left;margin-right:10px">递进方向应该是</div>
        <el-select v-model="data.adRules.common[0].value" placeholder="请选择">
          <el-option
      ...
      <div class="rthirty-five-box3">
        <el-checkbox v-model="data.adRules.common[0].checked">将此规则作为偏好规则（不严格要求）</el-checkbox>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      options: [{ value: '1', label: '向前' }, { value: '2', label: '向后' }]
    }
  },
  watch: {
    'parent': {
