        ...
        <el-select v-model="value" placeholder="请选择文hh件类型">
          ...
          />
            ...
            <div style="margin-left:30px;">
              <el-button type="primary" size="small" @click="searchInput">搜 索</el-button>
            </div>
            <div class="right-section2" @click="newWorkloadClick">
...
<script>
import { initTable, search, remove } from '@/api/workload'
export default {
  name: 'StaticWorkload',
  data() {
    return {
  ...
  methods: {
    ...
    newWorkloadClick() {
      this.$router.push({ path: 'workloadHidden' })
    },
    open(index, row) {
