...
import { add, edit } from '@/apiNew/checkInData'
export default {
  name: 'AddPage',
  ...
  methods: {
    ...
    next() {
      if (this.active === 1) {
        ...
        this.deskIds = this.$refs.stepTwo.value
    ...
    add() {
      console.log(localStorage.getItem('stepOne', JSON.stringify(this.stepOne)), 555)
