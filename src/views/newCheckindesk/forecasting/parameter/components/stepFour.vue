<template>
  <div>
    ...
    <div class="runtime-bottom">
      ...
      <div v-loading="loading" element-loading-text="计算中..." style="min-height: 300px; font-size: 14px; width: 100%" class="right">
...
import { initable, Prediction, reCalculate, stopClick } from '@/api/checkInNewHome'
export default {
