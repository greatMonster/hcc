    ...
    <div>
      <el-dialog v-dialogDrag :title="title" :visible.sync="attendanceDialogVisible">
        <el-form ref="form" :model="form">
          <el-form-item prop="name" label="缺席信息名称：" :label-width="formLabelWidth">
            <el-input v-model="form.name" placeholder="请输入缺席信息名称" />
          </el-form-item>
          <el-form-item prop="desc" label="描述：" :label-width="formLabelWidth">
            <el-input v-model="form.desc" placeholder="请输入描述" />
          </el-form-item>
          <el-form-item prop="chekList" label="选择原因代码：" :label-width="formLabelWidth">
            <el-checkbox-group v-model="form.checkList" style="flex-direction:column">
              <el-checkbox label="Requested by Airline" />
              <el-checkbox label="Not updated in system" />
              <el-checkbox label="Canceled by Flight Information System" />
            </el-checkbox-group>
          </el-form-item>
        </el-form>
