<template>
  <div>
    ...
    <form enctype="multipart/form-data" style="display:inline-block" method="post">
      <el-upload ref="upload" :action="postUrl" :name="file" :data="uploadData" :show-file-list="false" :before-upload="beforeAvatarUpload" :on-success="handleUploadSuccess" :on-error="handleUploadError">
