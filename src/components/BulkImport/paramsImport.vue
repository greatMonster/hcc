<template>
  <div>
    <form enctype="multipart/form-data" style="display:inline-block" method="post">
      <el-upload ref="upload" :action="postUrl" :name="name" :data="conditions" :show-file-list="false" :on-success="handleUploadSuccess" :headers="headersData" :on-error="handleUploadError">
