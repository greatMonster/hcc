...
export default {
  ...
  methods: {
    ...
    setOptions({ max1Y, max2Y, expectedData, expectedData2, isShow, legendData, actualData, dataX, actualDataName, expectedDataName, expectedDataName2, waitList, realWaitList, maxY, maxWaitTime, leftMax, leftMax2, rightMax, max3Y } = {}) {
          ...
          },
          {
            ...
            markLine: {
              ...
              label: {
                ...
                formatter: expectedDataName2 + '峰值：' + max3Y
              },
              data: [
                {
                  ...
                  name: expectedDataName2 + '峰值：' + max3Y,
                  yAxis: max3Y
                }
              ]
            },
